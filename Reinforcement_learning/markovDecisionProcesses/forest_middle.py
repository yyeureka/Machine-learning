...
# for i in range(len(epsilon)):
#     np.random.seed(SEED)
#     ql = mdp.QLearning(T, R, gamma=0.99, alpha=0.9, epsilon=epsilon[i], n_iter=200000)
#     ql.run()
...
#     np.random.seed(SEED)
#     ql = mdp.QLearning(T, R, gamma=0.99, alpha=alpha[i], epsilon=0.4, n_iter=200000)
#     ql.run()
...
ql = mdp.QLearning(T, R, gamma=0.99, alpha=0.9, epsilon=0.4, n_iter=200000)
ql.run()
