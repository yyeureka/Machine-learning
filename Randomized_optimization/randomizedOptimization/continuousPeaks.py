...
problem = mlrose_hiive.DiscreteOpt(length=20, fitness_fn=fitness, maximize=True, max_val=2)
...
# # Simulated annealing
# best_state, best_fitness, curve = mlrose_hiive.simulated_annealing(problem, schedule=mlrose_hiive.ArithDecay(), curve=True, random_state=SEED)
...
# print(best_fitness)
# # MIMIC
# best_state, best_fitness, curve = mlrose_hiive.mimic(problem, pop_size=400, keep_pct=0.2, curve=True, random_state=SEED)
...
for i in range(len(problem_size)):
    ...
    best_state, best_fitness, curve, evals = mlrose_hiive.simulated_annealing(problem, schedule=mlrose_hiive.ArithDecay(),
    ...
    # Genetic algorithm
    t0 = time()
    best_state, best_fitness, curve, evals = mlrose_hiive.genetic_alg(problem, pop_size=400, mutation_prob=0.5,
                                                                      curve=True, fevals=True, random_state=SEED)
    t1 = time()
    ...
    # MIMIC
    t0 = time()
    best_state, best_fitness, curve, evals = mlrose_hiive.mimic(problem, pop_size=400, keep_pct=0.2, curve=True,
