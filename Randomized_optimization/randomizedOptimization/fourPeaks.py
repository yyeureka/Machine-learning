...
# MIMIC
best_state, best_fitness, curve = mlrose_hiive.mimic(problem, pop_size=500, keep_pct=0.2, curve=True, random_state=SEED)
...
for i in range(len(problem_size)):
    ...
    # MIMIC
    t0 = time()
    best_state, best_fitness, curve, evals = mlrose_hiive.mimic(problem, pop_size=500, keep_pct=0.2, curve=True,
